  ...
  <el-row style="background-color: #FFFFFF;padding: 10px 0;border-radius: 5px;">
    <el-row style="padding: 10px 0 20px;border-bottom: 1px solid #f1f1f1;margin: 0 10px;">
      <el-row>
        ...
        <el-input size="small" style="width: 188px;" v-model="userQueryDto.userAccount" placeholder="输入处" clearable
          @clear="handleFilterClear">
        </el-input>
        <span class="top-bar">用户邮箱</span>
        <el-input size="small" style="width: 188px;" v-model="userQueryDto.userEmail" placeholder="输入处" clearable
          @clear="handleFilterClear">
        </el-input>
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-switch style="user-select: none;margin-right: 20px;" v-model="userQueryDto.isWord" active-color="#13ce66"
          inactive-color="rgb(226, 226, 226)">
        </el-switch>
        <span class="top-bar">封号</span>
        <el-switch style="user-select: none;margin-right: 20px;" v-model="userQueryDto.isLogin" active-color="#13ce66"
          inactive-color="rgb(226, 226, 226)">
        </el-switch>
    ...
    <el-row style="margin: 10px;">
      <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="isLogin" width="108" label="封号">
          <template slot-scope="scope">
            <el-switch @change="
              handleSwitchChange(scope.row.id, scope.row.isLogin, true)
        ...
        <el-table-column prop="isWord" width="108" label="禁言">
          <template slot-scope="scope">
            <el-switch @change="
              handleSwitchChange(scope.row.id, scope.row.isWord, false)
