...
<script>
import { clearToken, setUserId } from "@/utils/storage.js";
...
export default {
  ...
  methods: {
    healthModelChange() {
      const healthModel = this.healthModelConfig[
        this.selecedHealthModelIndex - 2
      ];
    ...
    eventListener(event) {
      ...
      } else if (event === "dietHistoryRecord") {
